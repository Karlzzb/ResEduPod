...
Ported verbatim from ``deeptutor/agents/math_animator/duration_utils.py``.
"""
...
def parse_target_duration_seconds(text: str) -> float | None:
    """Parse an explicit duration target (seconds) from user text, else ``None``."""
...
__all__ = ["parse_target_duration_seconds"]
